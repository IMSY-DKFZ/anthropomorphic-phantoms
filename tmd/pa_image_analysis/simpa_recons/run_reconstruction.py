...
from tmd.utils.default_settings import (get_default_das_reconstruction_settings,
                                        get_default_tr_reconstruction_settings)
...
# examples_images = [("Study_28", "Scan_1"), ("Study_28", "Scan_"), ("Study_19", "Scan_1"), ("Study_20", "Scan_1")]
examples_images = [("Study_27", "Scan_17"), ("Study_27", "Scan_18"), ("Study_27", "Scan_19")]
    ...
    for scan in scans:
        ...
        if not frame_averaging:
            ...
            if not isinstance(frame_averaging, tuple):
                ...
                frame_ranges = range(frame_averaging[0], frame_averaging[1] + 1)
        ...
        for frame in frame_ranges:
            ...
            save_path = save_path.replace(".hdf5", "_recon.hdf5")
            ...
            device = sp.MSOTAcuityEcho(field_of_view_extent_mm=np.array([-20, 20, 0, 0, -4, 16]))
